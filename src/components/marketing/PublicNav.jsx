  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-s-6 lg:px-s-9 h-[64px] flex items-center justify-between">
        <Link to="/" className="flex items-center gap-s-3 text-ink-0">
          <Mark />
          <span className="font-display text-[18px] tracking-[-0.005em]">Train To Teach Africa</span>
        </Link>
...
function Mark() {
  return (
    <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden="true">
      <rect x="2" y="2" width="28" height="28" rx="8" fill="#13162a" stroke="#e5a62a" strokeWidth="1.5"/>
      <path d="M10 11h12M10 16h12M10 21h7" stroke="#e5a62a" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
