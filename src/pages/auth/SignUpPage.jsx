    ...
    >
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-s-5" noValidate>
        ...
        <p className="text-[12px] text-ink-3 text-center">
          By creating an account you agree to our <a href="/terms" className="text-gold-200 hover:text-gold-50 underline">Terms of Use</a> and <a href="/privacy" className="text-gold-200 hover:text-gold-50 underline">Privacy Policy</a>.
        </p>
      </form>
    </AuthLayout>
  );
