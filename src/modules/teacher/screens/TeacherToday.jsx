...
function LessonRow({ time, subject, topic, done, current }) {
  return (
    ...
    >
      ...
      >
        <Icon name={done ? 'check' : current ? 'player-play' : 'book'} className="text-[16px]" />
      </div>
          ...
          <Card>
            ...
            <div className="space-y-2">
              <div className="flex gap-3 p-3 rounded-lg" style={{ background: 'rgba(239,83,80,0.07)', borderLeft: '3px solid var(--c-red-400)' }}>
                <Icon name="user-x" className="text-[17px] text-[var(--c-red-400)] mt-0.5 shrink-0" />
                <div>
              ...
              <div className="flex gap-3 p-3 rounded-lg" style={{ background: 'rgba(245,165,36,0.07)', borderLeft: '3px solid var(--c-amber-400)' }}>
                <Icon name="chart-line-down" className="text-[17px] text-[var(--c-amber-400)] mt-0.5 shrink-0" />
                <div>
          ...
          <Card>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                >
                  <Icon name={a.icon} className="text-[16px] accent-text" />
                  {a.label}
                </button>
              ))}
            </div>
