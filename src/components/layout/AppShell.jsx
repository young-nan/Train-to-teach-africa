...
// ── Icon primitives ─────────────────────────────────────────────────────────
// We use Tabler Icons webfont loaded in styles.css
// These are tiny wrappers so components stay readable
function TI({ icon, className = '' }) {
  return <i className={`ti ti-${icon} ${className}`} aria-hidden="true" />;
}
